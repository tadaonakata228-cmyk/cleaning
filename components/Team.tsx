    ...
    return (
        <section id="team" className="py-24 bg-slate-50 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                ...
                <div className="absolute bottom-20 left-0 w-80 h-80 bg-blue-100 rounded-full blur-3xl opacity-30 -translate-x-1/2"></div>
            </div>
                    ...
                    {team.map((member, index) => (
                        ...
                        >
                            ...
                            <div className="relative p-6 flex flex-col items-center">
                                <div className="w-32 h-32 rounded-full p-1 bg-gradient-to-br from-brand-100 to-blue-50 mb-6 relative group-hover:scale-105 transition-transform duration-500">
                                    <img
                                        src={member.image}
                                        alt={member.name}
                                ...
                                <div className="flex gap-2 w-full">
                                    ...
                                    <div className="flex-1 bg-blue-50 rounded-lg py-2 px-3 flex flex-col items-center text-center">
                                        ...
                                        <span className="text-[10px] uppercase font-bold text-blue-400 tracking-wide">{member.reviews} отзывов</span>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
